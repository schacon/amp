...
== SYNOPSIS:
  ...
  remote = Repositories::HTTPRepository.new "https://user:password@bitbucket.org/carbonica/amp"
  ...
  (puts "You need to fix shit!"; new_irb_session binding) unless result.success?
