module Amp
  ...
  class AbstractLocalRepository
    ...
    def get_file(file, revision); end
    ...
    # a no-op.
    # Returns boolean
    def mark_conflicted(*filenames); end
    ...
    # Returns boolean
    def mark_resolved(*filenames); end
  end
